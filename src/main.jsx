        ...
        <div className="screen paper editorScreenPretty">
          ...
          <div className="scrapCanvas">
            ...
            <div className="quoteCard">
              ...
              <div className="tinyHeart">
                ♡
              </div>
            </div>

            <div className="photoFrame selectedPhoto">
          ...
          <div className="toolPanel">
            <button>🖼️<span>Photo</span></button>
            <button>💬<span>Sticker</span></button>
            <button>𝑇<span>Text</span></button>
            <button>🌄<span>Background</span></button>
            <button>✎<span>Doodle</span></button>
          </div>

          <div className="toolPanel secondTools">
            <button>▧<span>Layers</span></button>
            <button>🗑️<span>Delete</span></button>
            <button>⧉<span>Duplicate</span></button>
            <button>⇧<span>Forward</span></button>
            <button>⇩<span>Backward</span></button>
          </div>
    ...
    <div className="phone">
      <div className="screen paper homeLikeScreenshot">
        ...
        <div className="shortcutTray">
          ...
          <button onClick={() => flash("Fonts coming soon Aa")}>
            Aa
            <br />
            Fonts
          </button>
